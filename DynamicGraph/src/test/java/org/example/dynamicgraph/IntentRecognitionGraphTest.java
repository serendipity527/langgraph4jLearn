 ...
 * 意图识别流程图测试
 * 
 * 流程：开始 -> 意图识别 -> [WELCOME场景 / CHAT对话 / FollowUP场景] -> 结束
 */
@DisplayName("意图识别流程图测试")
class IntentRecognitionGraphTest {
     ...
     * 图状态类
     */
    public static class IntentState extends AgentState {
     ...
     * WELCOME场景节点
     */
    private Map<String, Object> welcomeSceneNode(IntentState state) {
    ...
    @Test
    @DisplayName("测试意图识别分支图")
    void testIntentRecognitionGraph() throws GraphStateException {
        // 构建图
        ...
        stateGraph.addNode("welcomeScene", node_async(this::welcomeSceneNode));
